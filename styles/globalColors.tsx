    ...
    return StyleSheet.create(
        {
            ...
            containerColorMain: { backgroundColor: settingsGlobals.darkMode ? 'black' : 'white' },
            ...
            selectedButton: {
                backgroundColor: settingsGlobals.darkMode ? 'white' : 'black',
                borderColor: settingsGlobals.darkMode ? 'white' : 'black',
                color: settingsGlobals.darkMode ? 'black' : 'white',
            },
            unselectedButton: {
                backgroundColor: settingsGlobals.darkMode ? 'black' : 'white',
                borderColor: settingsGlobals.darkMode ? 'white' : 'black',
                color: settingsGlobals.darkMode ? 'white' : 'black',
            },
        }
    );
}

export let themeStyles = createThemeStyles();

export function updateThemeStyles() {
    themeStyles = createThemeStyles();
}
